...

{
	...
	menu[1].setFont(font);
	menu[1].setString("Sauvegarder");
	menu[1].setPosition(sf::Vector2f(width - 580, height-500));
	menu[1].setCharacterSize(15);

	
	menu[2].setFont(font);
	menu[2].setString("Quitter");
	menu[2].setPosition(sf::Vector2f(width - 580, height-420));
	menu[2].setCharacterSize(15);


	menu[3].setFont(font);
	menu[3].setString("Zurvival Arena");
	menu[3].setPosition(sf::Vector2f(width - 190, height - 600));
	menu[3].setCharacterSize(50);
	
	menu[3].setOutlineThickness(10);
